...
* $tmp_obj->setNome($nome);
* $tmp_obj->setDatanascimento($datanascimento);
* $tmp_obj->setCpf($cpf);
* $tmp_obj->setEmail($email);
* $tmp_obj->setTelefone($telefone);
* $tmp_obj->setDatecreated($datecreated);
* $tmp_obj->setCreatedby($createdby);
* $tmp_obj = null;
...
if(!class_exists("Cliente")) require_once("Cliente");
$json = json_decode("php://input");

$obj = new Cliente();
$obj->setIdcliente($json->idcliente);
$obj->setNome($json->nome);
$obj->setDatanascimento($json->datanascimento);
$obj->setCpf($json->cpf);
$obj->setEmail($json->email);
$obj->setTelefone($json->telefone);
$obj->setDatecreated($json->datecreated);
$obj->setCreatedby($json->createdby);




idcliente: <input type='text' id='idcliente' class='to-save'><br>
nome: <input type='text' id='nome' class='to-save'><br>
datanascimento: <input type='text' id='datanascimento' class='to-save'><br>
cpf: <input type='text' id='cpf' class='to-save'><br>
email: <input type='text' id='email' class='to-save'><br>
telefone: <input type='text' id='telefone' class='to-save'><br>
datecreated: <input type='text' id='datecreated' class='to-save'><br>
createdby: <input type='text' id='createdby' class='to-save'><br>
