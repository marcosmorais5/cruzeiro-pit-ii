		...
		<script>
			...
			jQuery(document).ready(function(){
					...
					$.ajax({
						...
						url: "opme_crud.php?fila=sim&"+ parte_url,
						cache: false,
						type: 'GET',
							...
							if(data.response_code == 200){
								...
								$.each(data.fila, function(i, obj){
									...
									let linha = "<tr class='linhas'>"+
										"<td class='linha_cod link_id'><a href='opme_cadastro.php?idopme="+ obj.idopme +"'>Abrir "+ obj.idopme +"</a></td>"+
										"<td class='linha_procedimento'>"+ obj.opme +"</td>"+
										"</tr>\n";
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-10 pt-md-2 bg-white text-dark">
				...
				<div id="filaDados">
					Carregando lista de procedimentos...
				</div>
			</div>
