			...
			jQuery(document).ready(function(){
				...
				if(<?=(int)$_GET['idmedico']?> > 0 ){
					...
					$.ajax({
						...
						url: "medico_crud.php?idmedico=<?=(int)$_GET['idmedico']?>",
						cache: false,
						type: 'GET',
				...
				let method_type = (<?=(int)$_GET['idmedico']?> > 0) ? "PUT" : "POST";
				/* POST ACTION: LISTEN THE FORM AND PARSE 'to-save' TO JSON */
				
				UTILS.postData({
					
					"obj": "#form_cad_medico",
					"action_page": "medico_crud.php",
					"json_class": ".to-save",
					"method_type": method_type,
					"return_page": "medico_lista.php"
				...
				$("#button_voltar_fila").click(function(){
					...
					location.href = 'medico_lista.php';
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-10 pt-md-2 bg-white text-dark">
					...
					<form id="form_cad_medico">
					
						<?php require_once("templates/medico.html"); ?>
						
						<?php if($_GET['idmedico'] > 0) { ?>
						...
						<?php }else{ ?>
						<button type="submit" id="button_submit"  title="Criar Usuário" class="btn btn-success">Criar Médico</button> 
